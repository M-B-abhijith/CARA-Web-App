...
const Roadmap = () => {
  ...
  // Function to get image path from src/roadmaps folder
  const getImagePath = (imageName) => {
    // Assuming images are in src/roadmaps and can be imported dynamically
    return require(`../roadmaps/${imageName}`);
  };
          ...
          <div className="job-item" key={roadmap.id}>
            ...
            <div>
              <Button
                ...
                color="primary"
                onClick={() =>
                  navigate(`/moreinfo/${encodeURIComponent(roadmap.title)}`)
                }
              >
                More Info
              </Button>
